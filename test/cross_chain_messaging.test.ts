...
import { AccountWallet, AztecAddress, DebugLogger, EthAddress, Fr, computeAuthWitMessageHash, createDebugLogger, createPXEClient, sleep, waitForPXE } from '@aztec/aztec.js';
...
describe('e2e_cross_chain_messaging', () => {
    ...
    it('Privately deposit funds from L1 -> L2 and withdraw back to L1', async () => {
        ...
        console.log("Minted tokens on L1:" + l1TokenBalance);
